...
questions.cache['what_is_a_nuclide'] = {
    ...
    captions: [
        { x: 8, y: 8, line_height: 3.1,
          copy: "Atoms are made of [q]protons|What is a Proton?[q], [q]neutrons|What is a Neutron?[q], and [q]electrons|What is an Electron?[q]. The number of protons in an atom determines what element it is (and thus its chemistry).[br]Atoms of the same element can, however, have different numbers of neutrons inside their nuclei. More neutrons make an element[br]heavier without changing its chemistry. [em1]Atoms of the same element with different numbers of neutrons in the nucleus[em1][br][em1]are called \"isotopes\" of that element.[em1]"

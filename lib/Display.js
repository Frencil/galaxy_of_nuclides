...
display.regions.key.init = function(){
    ...
    display.time_slider.mouse_events = d3.behavior.drag()
        ...
        .on("drag", function(d){
            display.time_slider.slideTo(d3.event.y, true);
        })
        .on("dragend", function(d){
            display.time_slider.slideTo(display.time_slider.y, false);
        });
...
display.regions.key.regions.slider.draw = function(){
    ...
    d3.select("#slider").on("click", function(){
        var y = d3.event.y - (display.time_slider.slider_height / 2);

...
var display = {
    ...
    showDataset: function(data_type, override_settings){
        ...
        d3.selectAll("g." + data_type + "_display" + subclass).style("display", null);
        d3.selectAll("g." + data_type + "_display" + subclass).transition()
            ...
            .attr("transform", function(d){
                ...
                //if (isNaN(coords[0])){ console.log(settings.next_element); console.log(subclass); }
        ...
        if (settings.show_labels){
            display.fadeIn(d3.selectAll("text." + data_type + "_label" + subclass), settings.transition.duration);
        } else {
            display.fadeOut(d3.selectAll("text." + data_type + "_label" + subclass), settings.transition.duration);
        }
    ...
    hideDataset: function(data_type){
        ...
        d3.selectAll("text." + data_type + "_label").style("display", "none");
        d3.selectAll("g." + data_type + "_display").style("display", "none");
    },
    ...
    setCaptions: function(duration, delay, stagger_delay){
    ...
    setComponents: function(duration, delay, stagger_delay){
    ...
    highlightElement: function(element, bool){
        ...
        if (bool){  // Highlight
            ...
            if (display.current_layout == 'isotopes'){
                display.setThumbnail(display.current_element);
            }
        }
    },

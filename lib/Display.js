...
var display = {
    ...
    layouts: { periodic_table:    { data: { x: 6, y: 28, w: 180, h: 100 },
               ...
               element_detail:    { data: { x: 136, y: 4, w: 52, h: 52 },
                                    ...
                                    setHitboxes: function(){
                                        var focus = display.element_detail_focus;
                                        if (focus == null){ focus = display.next_element_detail_focus; }
    ...
    setZoomNuclide: function(nuclide){
        if (nuclide == null){
            ...
            // Initialize vars
            var zoom_w = display.layouts.chart_of_nuclides.zoom_nuclide.w * display.scale;
            var nuc_w  = display.layouts.chart_of_nuclides.nuclide.w * display.scale;
            var label_unit = zoom_w / 10;
            var x = display.layouts.chart_of_nuclides.getNuclideX(nuclide);
            var y = display.layouts.chart_of_nuclides.getNuclideY(nuclide) + nuc_w - zoom_w;
                ...
                if (typeof element != "undefined"){
                    (function(node, element){
                        node.on("mouseover", function(){
                            ...
                            transition.fire("element_detail", element.protons);
                        });
                    })(node, element);
                    ...
                    (function(node, nuclide){
                        node.on("mouseover", function(){
                            ...
                            transition.fire("element_detail", nuclide.protons);
                        });
                    })(node, nuclide);
                }
            }

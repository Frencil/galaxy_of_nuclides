...
colors = {
    element: function(d){
        ...
        return hsla(palette.getColor(relative_nuclides, 1));
    },
    nuclide: function(d){
        ...
        return hsla(palette.getColor(relative_halflife, 1));
    }
}

// Object for storing color palette
palette = {
...
function drawGalaxy(callback){
    ...
    dataset = d3.select("#dataset").selectAll(".element_shell")
        ...
        .each(function(d, i) {
            ...
            d3.select("#"+display_id)
                ...
                .attr("fill", function(d){ return colors.element(d); })
                .style("opacity", 0)
            ...
            d3.select("#"+this.id).selectAll(".nuclide")
                ...
                .each(function(d, i){
                    ...
                    d3.select("#"+display_id)
                        ...
                        .attr("fill", function(d){ return colors.nuclide(d); })
                        .style("opacity", 0);
                });
        });

...
function drawGalaxy(callback){
    ...
    // Draw image container for element detail layout
    d3.select("#stage").append("svg:image")
        .attr("id", "element_detail_image")
        .attr("x", display.layouts.element_detail.image.x * display.scale)
        .attr("y", display.layouts.element_detail.image.y * display.scale)
        .attr("width", display.layouts.element_detail.image.w * display.scale)
        .attr("height", display.layouts.element_detail.image.h * display.scale)
        .style("opacity", 0);

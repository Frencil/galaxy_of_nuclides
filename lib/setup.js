...
var display = {
    ...
    area:       { x: 0, y: 0, w: 256, h: 160 },
    stage:      { x: 0, y: 0, w: 192, h: 132 },
    title:      { x: 0, y: 132, w: 192, h: 28 },
    slider:     { x: 236, y: 0, w: 20, h: 160 },
    sliderinfo: { x: 192, y: 132, w: 44, h: 28 },
    nav:        { x: 192, y: 0, w: 44, h: 132 },

    // Layouts are displayed only inside the area defined by the stage
    // object. These objects provide details for specific layouts
    layouts: { periodic_table:    { data: { x: 6, y: 6, w: 180, h: 100 },
                                    element: { w: 9, m: 1 },
                                    nuclide: { w: null, m: null }, // These get set in setDisplayVars()
                                    info1: { x: 36, y: 84, w: 80, h: 40 },
                                    info2: { x: 124, y: 104, w: 48, h: 20 },
               ...
               chart_of_nuclides: { data: { x: 6, y: 6, w: 180, h: 120 },
                                    nuclide: { w: .8, m: .2 },
                                    info1: { x: 8, y: 84, w: 76, h: 40 },
                                    info2: { x: 100, y: 8, w: 84, h: 48 },
                                    getElementX: function(group, period){
                                        var base = display.scale * (display.layouts.periodic_table.element.w
                                                                  + display.layouts.periodic_table.element.m);
                                        if (group > 18){
               ...
               single_element:    { data: { x: 136, y: 76, w: 52, h: 52 },
                                    image: { x: 4, y: 4, w: 128, h: 72 },
                                    info1: { x: 4, y: 80, w: 128, h: 48 },
                                    info2: { x: 136, y: 4, w: 52, h: 68 } }
             },

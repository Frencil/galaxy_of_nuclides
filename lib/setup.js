...
function drawGalaxy(callback){
    ...
    info.append("clipPath")
        .attr("id", "info1_clip")
        .append("rect").attr("id", "info1_cliprect")
        .attr("x", 0).attr("y", 0).attr("width", 0).attr("height", 0);
    var info1_g = info.append("g")
        .attr("id", "info1")
        .attr("clip-path", "url(#info1_clip)");
    info1_g.append("text")
        .attr("id", "info1_title")
    ...
    info.append("clipPath")
        .attr("id", "info2_clip")
        .append("rect").attr("id", "info2_cliprect")
        .attr("x", 0).attr("y", 0).attr("width", 0).attr("height", 0);
    var info2_g = info.append("g")
        .attr("id", "info2")
        .attr("clip-path", "url(#info2_clip)");
    info2_g.append("text")
        .attr("id", "info2_title")
        .attr("class", "info title");
    ...
    // Secondary element hitboxes that highlight an element's nuclides s on the chart of nuclides
    d3.selectAll(".element_hitbox_group")
        .append("rect")

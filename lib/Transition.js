...
var transition = {
    ...
    periodic_table: {
        ...
        chart_of_nuclides: function(callback){
            ...
            transition.moveInfoBoxes('chart_of_nuclides', 10500);
    ...
    chart_of_nuclides: {
        ...
        periodic_table: function(callback){
            ...
            // Reposition info boxes
            transition.moveInfoBoxes('periodic_table', 11500);
    ...
    element_detail: {
        ...
        chart_of_nuclides: function(callback){
            ...
            // Reposition info boxes
            transition.moveInfoBoxes('chart_of_nuclides', 14500);
        ...
        element_detail: function(callback){
            ...
            console.log("requested focus: " + new_element_focus);

...
var transition = {
    ...
    periodic_table: {
        ...
        chart_of_nuclides: function(callback){
            ...
            show_nuclides.selectAll("g.nuclide_display").style("opacity",1);
        ...
        element_detail: function(callback){
            ...
            // Show nuclide labels
            d3.select("svg").transition().delay(3000).duration(1000)
    ...
    chart_of_nuclides: {
        ...
        periodic_table: function(callback){
            ...
            hide_nuclides.selectAll("g.nuclide_display").style("opacity",0);
        ...
        element_detail: function(callback){
            ...
            // Show nuclide labels
            d3.select("svg").transition().delay(11500).duration(1000)
                .selectAll("text.nuclide_display.e" +  display.next_element_detail_focus).style("opacity",1);
    ...
    element_detail: {
        ...
        element_detail: function(callback){
            ...
            d3.select("svg").transition(5000).delay(5000).duration(1000)
                .selectAll("text.nuclide_display.e" +  display.next_element_detail_focus).style("opacity",1);

...
var transition = {
    ...
    periodic_table: {
            ...
            setTimeout(function(){
                for (var e in matter.elements){
                    ...
                    d3.selectAll("g.nuclide_display.e" + element.protons).transition()
                        .delay((64 * element.protons) * display.transition_speed)
        ...
        element_detail: function(callback){
            ...
            setTimeout(function(){
                ...
                display.setBigImage(display.next_element_detail_focus);
    ...
    chart_of_nuclides: {
        ...
        element_detail: function(callback){
            ...
            setTimeout(function(){
                d3.select("#chart_of_nuclides_element_highlights").selectAll("rect.highlightbox").style("display", "none");

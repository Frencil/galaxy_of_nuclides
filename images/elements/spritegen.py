...
print("[SPRITEGEN] Found " + str(len(jpgs)) + " jpgs, max protons: " + str(max_protons))
...
print("[SPRITEGEN] Initialized sprite map: " + str(map_width) + "x" + str(map_height))
...
for jpg_path in jpgs:
    ...
    print("[SPRITEGEN] Pasting " + jpg_path)
    sprite_map.paste(jpg, offset)

# Save the map as a PNG. Done!
print("[SPRITEGEN] Writing final sprite map")
